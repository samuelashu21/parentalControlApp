    ...
    <ScrollView contentContainerStyle={styles.scroll}>
      <ThemedView style={styles.container}>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={logout} style={[styles.logoutBtn, { borderColor: colors.icon }]}>
        ...
        <View style={styles.cardRow}>
          <View style={[styles.card, { borderColor: colors.tint }]}>
            ...
            <ThemedText style={{ color: colors.icon }}>Track children</ThemedText>
          </View>
          <View style={[styles.card, { borderColor: colors.tint }]}>
        ...
        <View style={styles.cardRow}>
          <View style={[styles.card, { borderColor: colors.tint }]}>
            ...
            <ThemedText style={{ color: colors.icon }}>Manage devices</ThemedText>
          </View>
          <View style={[styles.card, { borderColor: colors.tint }]}>
            <ThemedText style={styles.cardIcon}>🔗</ThemedText>
            <ThemedText type="defaultSemiBold">Link Child</ThemedText>
            <ThemedText style={{ color: colors.icon }}>Use Devices tab</ThemedText>
          </View>
        </View>

        <ThemedText style={[styles.hint, { color: colors.icon }]}>
          Use the tabs below to manage your child's location, geofences, and devices.
        </ThemedText>
      </ThemedView>
    </ScrollView>
  );
  ...
  return (
    <ScrollView contentContainerStyle={styles.scroll}>
      <ThemedView style={styles.container}>
        ...
        <ThemedText style={[styles.hint, { color: colors.icon }]}>
          Use the SOS tab for emergencies, and the Privacy tab to manage your tracking preferences.
        </ThemedText>
      </ThemedView>
    </ScrollView>
  );
