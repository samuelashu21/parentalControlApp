...
export default function LocationScreen() {
  ...
  const [latestLocation, setLatestLocation] = useState<LocationRecord | null>(
    null,
  );
        ...
        {!selectedChild && (
          <View style={[styles.infoCard, { borderColor: colors.tint }]}>
            ...
            <ThemedText style={{ color: colors.icon }}>
              After linking a child in the Devices tab, tap their card there to
              view their location, or enter their ID below.
            </ThemedText>
          </View>
        )}
          ...
          <>
            ...
            {loading ? (
              ...
              <>
                {latestLocation && (
                  <View
                    style={[styles.latestCard, { borderColor: colors.tint }]}
                  >
                    <ThemedText type="defaultSemiBold">
                      📍 Latest Location
                    </ThemedText>
                    ...
                    <ThemedText>
                      Lng: {latestLocation.longitude.toFixed(6)}
                    </ThemedText>
